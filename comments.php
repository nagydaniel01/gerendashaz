		...
		<div class="section__content">
			...
			<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
				<nav class="nav nav--comment" role="navigation">
					<span class="visually-hidden"><?php _e( 'Comment navigation', 'gerendashaz' ); ?></span>
					<div class="nav__content">
						<?php if ( get_previous_comments_link() ) : ?>
							<div class="nav__item nav__item--prev"><?php previous_comments_link( __( '&larr; Older Comments', 'gerendashaz' ) ); ?></div>
						<?php endif; ?>
						<?php if ( get_next_comments_link() ) : ?>
							<div class="nav__item nav__item--next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'gerendashaz' ) ); ?></div>
						<?php endif; ?>
					</div>
				</nav>
			<?php endif; ?>
			...
			<?php if ( ! comments_open() && get_comments_number() ) : ?>
				<p class="no-comments"><?php _e( 'Comments are closed.', 'gerendashaz' ); ?></p>
			<?php endif; ?>
		</div>
	<?php endif; ?>
