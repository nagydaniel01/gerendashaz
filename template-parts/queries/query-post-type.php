                ...
                <?php if ($current_page > 1) : ?>
                    <li>
                        <a href="" data-number="1" class="page-numbers first js-pagination-link">
                            <span class="page-numbers__label"><?php _e('First page', 'gerendashaz'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($current_page < $max_page) : ?>
                    <li>
                        <a href="" data-number="<?php echo $max_page; ?>" class="page-numbers last js-pagination-link">
                            <span class="page-numbers__label"><?php _e('Last page', 'gerendashaz'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
...
<?php else : ?>
    <p class="no-result"><?php echo esc_html__('Sorry, no posts matched your criteria.', 'gerendashaz'); ?></p>
<?php endif; ?>
