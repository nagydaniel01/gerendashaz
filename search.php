...
<?php
    ...
    $pagination_args = [
        ...
        'end_size'              => 1,
        'mid_size'              => 2,
        'prev_text'             => sprintf('<span class="page-numbers__label">%s</span><svg class="icon icon-arrow-left"><use xlink:href="#icon-arrow-left"></use></svg>', __('Previous', 'gerendashaz')),
        'next_text'             => sprintf('<span class="page-numbers__label">%s</span><svg class="icon icon-arrow-right"><use xlink:href="#icon-arrow-right"></use></svg>', __('Next', 'gerendashaz')),
        'type'                  => 'list',
        //'before_page_number'    => '',
        'after_page_number'     => '<span class="visually-hidden"> ' . __('Page', 'gerendashaz') . '</span>',
    ];
?>
